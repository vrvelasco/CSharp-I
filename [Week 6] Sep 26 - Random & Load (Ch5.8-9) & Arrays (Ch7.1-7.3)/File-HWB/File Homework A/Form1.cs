...
namespace File_Homework_A
{
    public partial class Form1 : Form
    {
        ...
        private void unplannedButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    randExpense = rand.NextDouble()*100.0; // Cents

                    // Write Random value
                    saveFile1.WriteLine(randExpense.ToString("n2"));
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            double line, defaultSum = 0;

            // Open file
            defaultFile = File.OpenText("Default.txt");

            while (!defaultFile.EndOfStream)
            {
                // Read line
                line = double.Parse(defaultFile.ReadLine());

                // Add lines
                defaultSum += line;

                // Load a Default expenses file
                expensesListBox.Items.Add(line);

                // Display Default Expenses
                totalLabel.Text = "Default Expenses: " + defaultSum.ToString("c");
            }
        }
            ...
            try
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    for (int i = 1; i <= expensesListBox.Items.Count; i++)
                    {
                        ...
                        //Add total
                        total += double.Parse(listBoxEntry);
                    }
